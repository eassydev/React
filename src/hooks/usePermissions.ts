...
export const usePermissions = () => {
   ...
   */
  const hasPermission = useCallback((url: string): boolean => {
   ...
   */
  const hasAnyPermission = useCallback((urls: string[]): boolean => {
   ...
   */
  const hasAllPermissions = useCallback((urls: string[]): boolean => {
   ...
   */
  const requirePermission = useCallback((url: string) => {
