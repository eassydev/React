      ...
      try {
        ...
        if (attribute) {
          ...
          const matchingCategory = categoriesResponse.data.find(
            (cat: WolooCategory) => cat.sampleid == attribute.category_id
          );
          ...
          if (attribute.subcategory_id) {
            const matchingSubcategory = subcategoriesResponse.data.find(
              (sub: WolooSubcategory) => sub.sampleid == attribute.subcategory_id
            );
