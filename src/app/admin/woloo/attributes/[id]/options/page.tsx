            ...
            <CardContent>
              <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>
                    Attribute Type:{' '}
                    {attribute.type === 'single' ? 'Single Selection' : 'Multiple Selection'}
                  </strong>
                </p>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setEditingOption((prev) =>
                            prev
                              ? { ...prev, price_modifier: parseFloat(e.target.value) || 0 }
                              : null
                          )
                        }
                        placeholder="0.00"
                      ...
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setEditingOption((prev) => (prev ? { ...prev, active: checked } : null))
                          }
                        />
