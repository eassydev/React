        ...
        if(booking.address_id)
          {
            const providerData = await fetchProvidersByFilters(
              booking.category_id || '',
              booking.subcategory_id || '',
              booking.filter_attribute_id || '',
              booking.filter_option_id || ''
            );
            setProviders(
