      ...
      cell: ({ row }) => (
        <div className="flex items-center space-x-2">
          <Button variant="ghost" size="icon">
            <Link href={`/admin/course-quiz/edit/${row.original.id}`} passHref>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <p>Are you sure you want to delete quiz: {row.original.title}?</p>
              </AlertDialogHeader>
              <AlertDialogFooter>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-4 md:p-8">
      <div className="max-w-12xl mx-auto space-y-6">
        <div className="flex justify-between mb-4">
          <h1 className="text-2xl font-bold">Course Quiz List</h1>
          <div className="flex space-x-2">
            ...
            <Link href="/admin/course-quiz/add">
              <Button>
        ...
        <Card className="border-none shadow-xl bg-white/80 backdrop-blur">
          <CardHeader className="flex flex-row items-center justify-between gap-4">
            <CardTitle className="text-xl text-gray-800">Quizzes</CardTitle>
            ...
            <Table>
              ...
              <TableBody>
                {table.getRowModel().rows.length ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={quizColumns.length} className="h-24 text-center">
                      No quizzes found.
                    </TableCell>
                  </TableRow>
                )}
