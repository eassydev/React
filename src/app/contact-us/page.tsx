  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Network Error',
        description:
          'Please check your connection and try again, or contact us directly at support@eassylife.in',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 p-4 md:p-8">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-500">© 2025 Eassy Life. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
